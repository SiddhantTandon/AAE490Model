function [P_forward, P_forward_accel, t_forward_accel_hr] = Power_Forward_Flight(weight, rho, radius, a, tipMach, s, beta_cruise, beta_accel, V_inf, accel_forward)

% Constants
Cdp = 0.338;                % Propeller Drag Coefficient
