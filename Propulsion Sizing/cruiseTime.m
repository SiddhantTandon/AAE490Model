...
%   t_accel_decel_forward - Time required to accelerate and decelerate in the forward direction [sec]
% 
% Outputs:
%   t_crusie_min - Required cruise time per Martian sol to completely cover given area [min]
% 
% ASSUMPTIONS:
%   Constant acceleration to a fixed cruise velocity, and constant deceleration from the same velocity (acceleration value chosen in main script)
