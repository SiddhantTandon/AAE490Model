function [P_descend, Time_descend_hr, t_descend_accel_hr] = Power_Descend(weight, rho, radius, a, tipMach, Cdp, s, Vdescend, h, A_body, Cd_body, numProp, accel_descend, P_hover)
...
% Calculate Power to Descend
    ...
    if Vdescend_final >= (2*v_i_0)
    
        Vdescend = Vdescend_final;
