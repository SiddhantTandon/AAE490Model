...
mass_avail = mass_total - mass_batt - mass_blades - mass_all_motors - mass_all_ESC - mass_panel - mass_cooling;        % Available mass left over after considering propulsion/power system 
...
fprintf('Mass of all PCM Cooling: %.2f kg\n',mass_cooling)
...
fprintf('Volume of Motor PCM: %.2f [L] (liquid)\n', V_PCM_motor * 1000)
fprintf('Volume of Battery PCM: %.2f [L] (liquid)\n', V_PCM_battery * 1000)
fprintf('Percentage change in volume: %.2f%%\n', percent_V_change*100)
